...
hero_mm1 = hero("Claude", "Marksman", "attack damage", 2460, 448, 123)
hero_fighter1 = hero("Yin", "Fighter", "attack damage", 2698, 0, 129)
hero_mid1 = hero("Lunox", "Mid", "Magic Damage", 2616, 270, 111)
hero_roam1 = hero("Floryn", "Roam", "Healing", 2221, 545, 120)
